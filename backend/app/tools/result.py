...
class ToolResult:
    ...
    @classmethod
    def ok(cls, data: Any = None, summary: str = "", *, warnings: list[str] | None = None, metadata: dict[str, Any] | None = None, compact_data: Any = None) -> ToolResult:
        return cls(success=True, data=data, summary=summary, warnings=warnings or [], metadata=metadata or {}, compact_data=compact_data)
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {"success": self.success, "data": self.data, "summary": self.summary, "warnings": self.warnings, "errors": self.errors, "metadata": self.metadata}
